...
let highestTotal = Math.max(taj, john, kwa);
let winner = ""

if(highestTotal === taj) { 
  winner = "Taj";
} else if( highestTotal === john ) { 
  winner = "John";
} else winner = "Kwa";
...
const containsJava =  programWords.includes("java");
const containsCss =  programWords.includes("css");

let javaValue = containsJava.valueOf();
let cssValue = containsCss.valueOf();

if (javaValue === true && cssValue === true ){
  console.log("Yes, the array contains Java and CSS.");
} else {
  console.log("No, it does not contain Java and CSS.");
}
